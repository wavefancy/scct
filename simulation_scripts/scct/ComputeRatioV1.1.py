...
'''
    Compute ratio and normalized by frequency category average value.
...
def help():
    ...
    para4: File contains the frequency specific average value.
    
    @Note:
    1. Add one column for computed ratio
    2. Column index starts from 1.
    3. Read from stdin and output stdout.
    -----------------------------------------------
    \n''')
    sys.stderr.close()
    sys.exit(-1)
