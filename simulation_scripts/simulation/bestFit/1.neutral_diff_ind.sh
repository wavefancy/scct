# Simulate different number of samples
...
do
    ...
    echo "java -jar -Xmx100G ~/scct/msms.jar ${t_n} 300 -t 18000 -r 15600 -N 100000 -I 2 ${h_n} ${h_n} -en 0.0005 1 0.24 -en 0.000875 2 0.077 -ej 0.00875 2 1 -en 0.0425 1 0.125 -threads 20 | gzip > AFR_CEU.neu.n${num}.gz"
done
