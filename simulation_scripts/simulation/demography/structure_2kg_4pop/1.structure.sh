...
do
    ...
    echo "java -jar -Xmx16G ~/scct/msms.jar 240 300 -t 18000 -r 15600 -N 100000 -I 5 30 30 30 30 120 ${s} -m 1 5 0 -m 5 1 0 -m 2 5 0 -m 5 2 0 -m 3 5 0 -m 5 3 0 -m 4 5 0 -m 5 4 0 -en 0 1 0.25 -en 0 2 0.25 -en 0 3 0.25 -en 0 4 0.25 -en 0.0005 1 0.06 -en 0.0005 2 0.06 -en 0.0005 3 0.06 -en 0.0005 4 0.06 -ej 0.005 4 1 -ej 0.005 3 1 -ej 0.005 2 1 -en 0.005 1 0.24 -en 0.000875 5 0.077 -ej 0.00875 5 1 -en 0.0425 1 0.125 -threads 50 | gzip > AFR_CEU.sub.${s}.gz"
done
