...
# Different selection coefficient in YRI population
...
do
    let "saA=${sAA}/2"
    echo "java -jar -Xmx15G ~/scct/msms.jar 240 500 -t 18000 -r 15600 -N 100000 -I 2 120 120 -en 0.0005 1 0.24 -en 0.000875 2 0.077 -ej 0.00875 2 1 -en 0.0425 1 0.125 -SI 0.005 2 0.00001 0 -SAA ${sAA} -SaA ${saA} -Sp 0.5 -Smark -SFC -threads 40 | java -Xmx1G -jar ~/scct/MsDataSetSelectorV1.0.jar 0.5000000000 0.0025 1 |gzip > AFR_CEU.sel_yri.${sAA}.gz"
done
