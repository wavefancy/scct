# Simulate the variantion of recombination rate
...
do
    ...
    echo "java -jar -Xmx16G ~/scct/msms.jar 240 300 -t 18000 -r ${p} -N 100000 -I 2 120 120 -en 0.0005 1 0.24 -en 0.000875 2 0.077 -ej 0.00875 2 1 -en 0.0425 1 0.125 -threads 45 | gzip > AFR_CEU.neu.n${s}.gz"
done
