...
scan_res = mclapply(p_list, my_scan_hh, mc.cores=42)
...
save(scan_raw,file=paste(para,"_scan_raw_all.RData",sep=""))

#n_raw="../../../bestFit/ihs/yri/n.yri_scan_raw_all.RData"
n_raw=paste('../../mutation_neu/ihs/',para,'_scan_raw_all.RData',sep='')
load(n_raw)
